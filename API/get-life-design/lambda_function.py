...
question_ids = ['60fd86f0-7148-4b73-bc9f-4eb8715fe9e9','c7c29d0e-fe56-4ab9-899c-c304ea96b8f7',
                'a9b80cc7-f831-4e45-ba61-03b35d7484b7','c5003f9a-39de-4859-8298-b553cefd19b2',
                '40784847-795d-448e-922c-e7d79b1c37c3','050be841-d37b-4352-95de-56df389ccd0c']
...
def build_query(filters):
    ...
    query = """
        ...
        FROM
            student_response sr,
            jsonb_array_elements(sr.life_design) AS elem
        WHERE
...
def build_query_filters(filters):
    ...
    if 'inventory_version' in filters and filters['inventory_version']!='' :
    ...
    if 'org_name' in filters and filters['org_name']!='':
    ...
    if 'implementation_type' in filters and filters['implementation_type']!='':
