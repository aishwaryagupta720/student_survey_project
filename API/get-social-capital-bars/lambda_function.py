...
question_ids = ['776da580-aae2-48b4-ac29-a2d31d2b6de0','75724537-353a-4fb4-bd4e-0a2aae00af09','7a6596fe-f4bb-40f5-82cd-43372fe276ca','288d5cf2-7b31-4974-80c8-7e81d1020bd3']
...
def build_query(filters):
    ...
    query = """
        ...
        FROM
            student_response sr,
            jsonb_array_elements(sr.social_capital) AS elem
        WHERE
